...
const FeatureList = [
  {
    ...
    description: (
      <>
        A list of tools and technologies with which I have knowledge and
        experience.
      </>
    ),
  },
  ...
  },
  {
    ...
    description: (
      <>
        ...
        {getNumberOfDays('3/1/2024', getCurrentDay())} hours.
      </>
    ),
  },
  {
    ...
    <header className="hero hero--primary">
      <div className="container">
        ...
        <p className="hero__subtitle">
          I'm a front-end developer from Brazil, and this is my{' '}
          <span className="hero__highlight">knowledge repository!</span>
        </p>
